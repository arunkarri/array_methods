...
request.onload = function(){
    ...
    let asiaCountries = countries.filter((function(obj){
        return obj.region === 'Asia';
    }));
    console.log(asiaCountries);

    //Get all the countries with population of less than 2 lacs using Filter function
    let populationFilter = countries.filter((function(obj){
    ...
    let population = countries.reduce(function(a,b) {
        return a + parseInt(b.population);
    },0);
